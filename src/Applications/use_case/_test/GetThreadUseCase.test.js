...
describe('GetThreadUseCase', () => {
    it('should orchestrate the get thread use case properly', async () => {
        const mockThread = { id: 'thread-123', title: 'Title', body: 'Body', date: '2021-01-01', username: 'userA' };
        const mockComments = [
            { id: 'comment-1', content: 'comment1', date: '2021-01-01', username: 'userB', is_deleted: false }
        ];
        const mockReplies = [
            { id: 'reply-1', comment_id: 'comment-1', content: 'reply1', date: '2021-01-01', username: 'userC', is_deleted: false }
        ];
        ...
        expect(detailThread.comments[0].replies[0].content).toBe('reply1');
    });
});
